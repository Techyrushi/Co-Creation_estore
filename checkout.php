                  ...
                  <div class="row">
                     <div class="col-xxl-12">
                        <div class="page__title-content pl-150">
                           <h3 class="page__title">Login At CoCreation</h3>
                  ...
                  <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                           ...
                           <form action="checkout.php" method="post">
                              ...
                              <input id="name" name="c_email" type="text"  class="form-control" >
                              <label for="pass">Password <span>**</span></label>
                              <input id="pass" name="c_pass" type="password"  class="form-control" >
                              ...
                              <button name="login" class="e-btn e-btn-border w-100">Login Now</button>
                              <div class="or-divide"><span>or</span></div>
                              <a href="customer_register.php" class="e-btn e-btn-black e-btn-black-2 w-100">New? Register Now</a>
                           </form>
                        </div>
                  </div>
               </div>
...
<footer>
      ...
      <script type="text/javascript">
           ...
           function setcookie(){
            ...
            document.cookie="myusrname="+u+";path=http://localhost/CO-creation/";
            document.cookie="mypswd="+p+";path=http://localhost/CO-creation/";
           }
