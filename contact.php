...
<input type="text" class="form-controll" name="name" required>
...
<input type="text" class="form-controll" name="email" required>
...
<input type="text" class="form-controll" name="subject" required>
...
<textarea class="form-controll" name="message"> </textarea>
...
<label><h5>Select Enquiry Type</h5></label>


<select name="enquiry_type" class="form-controll"><!-- select Starts -->

<option><h4>Select Enquiry Type</h4></option>
...
</div><!-- form-group Ends --><br><br><br><br>


<div class="text-center"><!-- text-center Starts -->
<button type="submit" class="e-btn e-btn-border w-100 btn btn-primary" name="submit">
